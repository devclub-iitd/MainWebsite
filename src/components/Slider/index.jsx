...
export default class Slider extends React.Component {
	constructor(props) {
		...
		this.state = {
			animating: false, // Sets whether animation has begun or not
	...
	componentDidMount() {
		console.log("Component Did Mount - Slider");
	...
	componentWillUnmount() {
		console.log("Component Will Unmount - Slider");
		if (this.node) {
	...
	componentWillReceiveProps(newProps) {
		console.log("Component Will Receive Props - Slider",
					newProps.position,
					this.props.position);
	...
	startAnimation(position, animationCallback) {
		console.log("Slider Start Animation");
	...
	postPrepareAnimation() {
		console.log("Slider Post Prepare Animation");
