  ...
  window.dotCont = {
    ...
    initDots: function () {
      for (let i = 0; i < window.dotCont.dotNo; i++) {
        const [xt, yt] = window.dotCont.genRandCo(window.dotCont.xcor, window.dotCont.ycor);
        const param = {
          x: xt,
          y: yt,
          ...
          speed: Math.floor(window.dotCont.genRand(window.dotCont.dotSpeed) + 1),
...
export default withStyles(style)(Anim);
